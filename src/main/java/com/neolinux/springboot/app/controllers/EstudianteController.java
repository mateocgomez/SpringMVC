...
public class EstudianteController {
	...
	public String ver(@PathVariable(value="id") Long id,
		...
		Estudiante estudiante = monitoriaService.findEstudianteById(id);
		
		if(estudiante == null) {
			flash.addFlashAttribute("error", "El estudiante no esta asignado a ninguna monitoria");
			return "redirect:/listar";
		}
		
		model.addAttribute("estudiante", estudiante);
		model.addAttribute("titulo", "Estudiante: ".concat(estudiante.getNombre()) );
